    ...
    <div className="flex h-[700px] w-full">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2 mb-5">
            <FaUser className="w-[13px] h-[17px] text-gray-500" />
